...
// y = ax+y
__kernel void knlAXPBY(int n, __global double* x, __global double *y, __global double *res, double a, double b){
...
__kernel void knlDOT(int n, __global double* x, __global double* y, __global double *res){
